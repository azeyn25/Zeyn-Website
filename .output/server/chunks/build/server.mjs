import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, h, defineAsyncComponent, toRef, isRef, defineComponent, provide, createElementBlock, computed, shallowReactive, Suspense, nextTick, Fragment, Transition, useSSRContext, unref, createApp, effectScope, reactive, getCurrentScope, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, mergeProps, shallowRef, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch$1, l as hasProtocol, m as isScriptProtocol, n as joinURL, w as withQuery, h as createError$1, o as withoutTrailingSlash, p as withLeadingSlash, q as hash, r as defu, t as sanitizeStatusCode, v as withBase, x as createHooks, y as klona, z as parse, A as getRequestHeader, B as destr, C as isEqual, D as setCookie, E as getCookie, F as deleteCookie, G as toRouteMatcher, H as createRouter$1 } from '../runtime.mjs';
...
const _routes = [
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import('./document-driven-CxTkXIgw.mjs').then((m) => m.default || m)
  }
];
...
const LazyAwardsItem = defineAsyncComponent(() => import('./AwardsItem-C7RKbt86.mjs').then((r) => r["default"] || r.default || r));
const LazyAwardsList = defineAsyncComponent(() => import('./AwardsList-DeZfUQ2t.mjs').then((r) => r["default"] || r.default || r));
const LazyBlogImage = defineAsyncComponent(() => import('./BlogImage-B-xfjXr2.mjs').then((r) => r["default"] || r.default || r));
const LazyContainer = defineAsyncComponent(() => import('./Container-DHcGr0RE.mjs').then((r) => r["default"] || r.default || r));
const LazyGalleriesList = defineAsyncComponent(() => import('./GalleriesList-qOeDAQsz.mjs').then((r) => r["default"] || r.default || r));
const LazyGalleryListItem = defineAsyncComponent(() => import('./GalleryListItem-Nmq3QWpB.mjs').then((r) => r["default"] || r.default || r));
const LazyHeroGrid = defineAsyncComponent(() => import('./HeroGrid-CF10vI4H.mjs').then((r) => r["default"] || r.default || r));
const LazyHeroText = defineAsyncComponent(() => import('./HeroText-g9IC9fd8.mjs').then((r) => r["default"] || r.default || r));
const LazyMasonryGallery = defineAsyncComponent(() => import('./MasonryGallery-DfRQ8sew.mjs').then((r) => r["default"] || r.default || r));
const LazyPackagePrice = defineAsyncComponent(() => import('./PackagePrice-Cl-y5DTa.mjs').then((r) => r["default"] || r.default || r));
const LazyPageHeader = defineAsyncComponent(() => import('./PageHeader-Cc2_DatX.mjs').then((r) => r["default"] || r.default || r));
const LazyQaItem = defineAsyncComponent(() => import('./QaItem-BN8gfhPV.mjs').then((r) => r["default"] || r.default || r));
const LazySectionAboutMe = defineAsyncComponent(() => import('./SectionAboutMe-Bgsn_EWb.mjs').then((r) => r["default"] || r.default || r));
const LazySectionCtaHireMe = defineAsyncComponent(() => import('./SectionCtaHireMe-oVYd8BD7.mjs').then((r) => r["default"] || r.default || r));
const LazySectionFaq = defineAsyncComponent(() => import('./SectionFaq-PhohAhzs.mjs').then((r) => r["default"] || r.default || r));
const LazySectionPackages = defineAsyncComponent(() => import('./SectionPackages-D2al_ut5.mjs').then((r) => r["default"] || r.default || r));
const LazySectionTestimonials = defineAsyncComponent(() => import('./SectionTestimonials--iNTxbC9.mjs').then((r) => r["default"] || r.default || r));
const LazyStoriesList = defineAsyncComponent(() => import('./StoriesList-ZM5rGHEJ.mjs').then((r) => r["default"] || r.default || r));
const LazyStoryListItem = defineAsyncComponent(() => import('./StoryListItem-Dlbm_Ihl.mjs').then((r) => r["default"] || r.default || r));
const LazyTestimonial = defineAsyncComponent(() => import('./Testimonial-DgEWQZZu.mjs').then((r) => r["default"] || r.default || r));
const LazyThreeImages = defineAsyncComponent(() => import('./ThreeImages-DDOWyqyG.mjs').then((r) => r["default"] || r.default || r));
const LazyContentDoc = defineAsyncComponent(() => import('./ContentDoc-DvQblJiO.mjs').then((r) => r["default"] || r.default || r));
const LazyContentList = defineAsyncComponent(() => import('./ContentList-J95p27dl.mjs').then((r) => r["default"] || r.default || r));
const LazyContentNavigation = defineAsyncComponent(() => import('./ContentNavigation-cKQ8UdNf.mjs').then((r) => r["default"] || r.default || r));
const LazyContentQuery = defineAsyncComponent(() => import('./ContentQuery-DJaRMNaT.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRenderer = defineAsyncComponent(() => import('./ContentRenderer-C1HDEB60.mjs').then((r) => r["default"] || r.default || r));
const LazyContentRendererMarkdown = defineAsyncComponent(() => import('./ContentRendererMarkdown-TaQqGoIg.mjs').then((r) => r["default"] || r.default || r));
const LazyContentSlot = defineAsyncComponent(() => import('./ContentSlot-n2VNQHpR.mjs').then((r) => r["default"] || r.default || r));
...
const LazyMarkdown = defineAsyncComponent(() => import('./Markdown-CgtZE8KR.mjs').then((r) => r["default"] || r.default || r));
const LazyProseA = defineAsyncComponent(() => import('./ProseA-pvqP0EdY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseBlockquote = defineAsyncComponent(() => import('./ProseBlockquote-Duha03KP.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCode = defineAsyncComponent(() => import('./ProseCode-C8LuAWsp.mjs').then((r) => r["default"] || r.default || r));
const LazyProseCodeInline = defineAsyncComponent(() => import('./ProseCodeInline-DR9Rc32T.mjs').then((r) => r["default"] || r.default || r));
const LazyProseEm = defineAsyncComponent(() => import('./ProseEm-D0t1j3Pu.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-CuTafI43.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-ClNWkTUZ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-6AJvVMJa.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-DDGv4K2H.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-BNOFZgSJ.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-9WuHZc20.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-D_Qld_x3.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-D88p5Ler.mjs').then((r) => r["default"] || r.default || r));
const LazyProseLi = defineAsyncComponent(() => import('./ProseLi-CG9fZvvK.mjs').then((r) => r["default"] || r.default || r));
const LazyProseOl = defineAsyncComponent(() => import('./ProseOl-Bk49cJJ0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseP = defineAsyncComponent(() => import('./ProseP-czZZtcCS.mjs').then((r) => r["default"] || r.default || r));
const LazyProseStrong = defineAsyncComponent(() => import('./ProseStrong-CeX0pQ8G.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTable = defineAsyncComponent(() => import('./ProseTable-DmyqPaUY.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTbody = defineAsyncComponent(() => import('./ProseTbody-DjOuI1ED.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTd = defineAsyncComponent(() => import('./ProseTd-FMRhPac4.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTh = defineAsyncComponent(() => import('./ProseTh-CBZ2MrTH.mjs').then((r) => r["default"] || r.default || r));
const LazyProseThead = defineAsyncComponent(() => import('./ProseThead-DYrel5P0.mjs').then((r) => r["default"] || r.default || r));
const LazyProseTr = defineAsyncComponent(() => import('./ProseTr-DXQ34IaA.mjs').then((r) => r["default"] || r.default || r));
const LazyProseUl = defineAsyncComponent(() => import('./ProseUl-BcWW6Af2.mjs').then((r) => r["default"] || r.default || r));
const LazyIcon = defineAsyncComponent(() => import('./Icon-DrKyOjLo.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-t62ThHbY.mjs').then((r) => r["default"] || r.default || r));
const lazyGlobalComponents = [
  ["AwardsItem", LazyAwardsItem],
  ["AwardsList", LazyAwardsList],
  ["BlogImage", LazyBlogImage],
  ["Container", LazyContainer],
  ["GalleriesList", LazyGalleriesList],
  ["GalleryListItem", LazyGalleryListItem],
  ["HeroGrid", LazyHeroGrid],
  ["HeroText", LazyHeroText],
  ["MasonryGallery", LazyMasonryGallery],
  ["PackagePrice", LazyPackagePrice],
  ["PageHeader", LazyPageHeader],
  ["QaItem", LazyQaItem],
  ["SectionAboutMe", LazySectionAboutMe],
  ["SectionCtaHireMe", LazySectionCtaHireMe],
  ["SectionFaq", LazySectionFaq],
  ["SectionPackages", LazySectionPackages],
  ["SectionTestimonials", LazySectionTestimonials],
  ["StoriesList", LazyStoriesList],
  ["StoryListItem", LazyStoryListItem],
  ["Testimonial", LazyTestimonial],
  ["ThreeImages", LazyThreeImages],
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-But-UTtT.mjs').then((m) => m.useContentDatabase());
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-But-UTtT.mjs').then((m) => m.generateNavigation);
...
const layouts = {
  default: () => import('./default-BR9IFtQR.mjs').then((m) => m.default || m),
  story: () => import('./story-DdCsJWAR.mjs').then((m) => m.default || m)
};
...
const cls_8D5GrZV4k4 = /* @__PURE__ */ defineNuxtPlugin(() => {
  return {
    provide: {
      /**
...
const index_eYYfe7Kp37 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-C0P7gtuF.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-pFGQp3-x.mjs').then((r) => r.default || r));
...
export { createQuery as A, componentName as B, __nuxt_component_0$1 as C, LayoutMetaSymbol as L, PageRouteSymbol as P, _wrapIf as _, useNuxtApp as a, useRoute as b, appLayoutTransition as c, useContent as d, entry$1 as default, useRequestEvent as e, useRouter as f, navigateTo as g, useRuntimeConfig as h, useContentPreview as i, asyncDataDefaults as j, createError as k, layouts as l, useState as m, nuxtLinkDefaults as n, fetchContentNavigation as o, useUnwrap as p, queryContent as q, resolveRouteObject as r, get as s, assertArray as t, useHead as u, ensureArray as v, sortList as w, apply as x, withoutKeys as y, withKeys as z };
