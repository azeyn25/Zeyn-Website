import _sfc_main$7 from "./Container-DHcGr0RE.js";
import { _ as __nuxt_component_0$1 } from "./nuxt-link-DwSMCMKW.js";
import { _ as __nuxt_component_1$1 } from "./nuxt-img-DNe_xHrX.js";
import { mergeProps, withCtx, createVNode, useSSRContext, defineComponent, createTextVNode, toDisplayString, unref, openBlock, createBlock, Fragment, renderList, Transition, ref } from "vue";
...
import { B as componentName, C as __nuxt_component_0$2, m as useState } from "../server.mjs";
const _sfc_main$6 = {};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_Container, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="dark:text-zinc-500 pb-16 mt-16"${_scopeId}><div class="text-center"${_scopeId}><p class="text-sm"${_scopeId}>© ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} `);
...
//# sourceMappingURL=Footer-BqOMaxuJ.js.map
