...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSlot, ssrGetDirectiveProps, ssrRenderComponent } from 'file:///Users/abdullahzeyn/code/Zeyn-Website/node_modules/vue/server-renderer/index.mjs';
import './server.mjs';
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtImg, {
        ...
        alt: ((_b = __props.photo) == null ? void 0 : _b.alt) ? __props.photo.alt : "Abdullah Zeyn",
...
//# sourceMappingURL=SectionAboutMe-Bgsn_EWb.mjs.map
